...
# matplotlib_scales<- read.csv(paste0(data_dir,"matplotlib_qualitative_colorscales_v2.csv"))
...
# write.csv(matplotlib_scales, paste0(results_dir,'matplotlib_qualitative_palettes_w_predictions_v2.csv'), row.names = FALSE)


write.csv(matplotlib_scales, paste0(results_dir,'matplotlib_colorscales_w_predictions_2.csv'), row.names = FALSE)
